...
var depthColor=["#f54242","#f56642","#f57542","##f59c42","#f5bc42","#f5ce42","#d1f542"]
...
function drawCircle(feature,layer){
  layer.circle(feature.geometry.coordinates, {
    stroke: false,
    fillOpacity: 0.75,
    color: "white",
    fillColor: "white",
    radius: markerSize(feature.population)
  })
}
...
L.geoJSON(someGeojsonFeature, {
  ...
  // // Create a GeoJSON layer that contains the circles array on the earthquakeData object.
  // // Run the onEachFeature function once for each piece of data in the array.
  // var earthquakeCircles = L.geoJSON(earthquakeData, {
  //   onEachFeature: drawCircle
  // });

  // // Send our Circles layer to the createMap function/
